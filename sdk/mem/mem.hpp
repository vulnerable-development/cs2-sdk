...
namespace sdk {
	...
	using pe_image_t = detail::pe_image_t;
	...
	template < bool _wide_t >
    struct rtl_str_t {
        using char_t = std::conditional_t< _wide_t, wchar_t, char >;
    ...
    struct peb_t {
        ...
        std::uint32_t               m_os_patform_id{},
                                    m_image_subsystem{},
                                    m_image_subsystem_major_version{},
                                    m_image_subsystem_minor_version{};
