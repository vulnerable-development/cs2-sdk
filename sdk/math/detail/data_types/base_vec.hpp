...
namespace sdk::detail {
    ...
    public:
        ...
        ALWAYS_INLINE constexpr _value_t length_sqr( const std::size_t size = _size ) const {
            ...
            const auto k_min_size = std::clamp( size, 2ull, _size );
            for ( std::size_t i{}; i < k_min_size; ++i )
    ...
    public:
        ...
        ALWAYS_INLINE constexpr base_vec_t( const _value_t x, const _value_t y )
            : base_t{ x, y } {}
    ...
    public:
        ...
        ALWAYS_INLINE base_qang_t< _value_t > angles(
            ...
            const auto length_2d = base_t::length( 2u );
            if ( up
                && length_2d > 0.001f ) {
                ret.x( ) = to_deg( std::atan2( -z( ), length_2d ) );
